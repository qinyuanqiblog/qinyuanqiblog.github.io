...
[阮一峰的详解](http://javascript.ruanyifeng.com/htmlapi/file.html)

* 一个demo 彻底明白fileReader的使用 [demo预览](https://qinyuanqiblog.github.io/wheel/fileReader.html)
